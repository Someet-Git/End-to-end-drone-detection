...
#     with col2:
#         st.image("https://raw.githubusercontent.com/ultralytics/assets/main/yolov8/banner-yolov8.png",
...
#                     avg_confidence = np.mean(confidence_scores[class_mask]) * 100
#                     st.write(f"- Detected {int(count)} instances of class {int(cls)} "
...
#     st.markdown("""
#     ### YOLO Architecture
#     YOLO (You Only Look Once) is a revolutionary approach to object detection that treats detection as a regression problem. Here's how it works:
#     """)
...
#        - Define classes and bounding boxes
